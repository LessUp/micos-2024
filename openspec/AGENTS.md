...
Use the lightweight change workflow for high-risk changes (orchestration, config,
provenance). Small low-risk fixes may follow the repository's existing process.
