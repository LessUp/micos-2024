...
def test_run_qc_passes_metadata_path_to_sample_discovery(tmp_path, monkeypatch):
    """run_qc 应将 metadata_path 转为 Path 传给 Sample.discover_paired."""
    captured = {}
    ...
    monkeypatch.setattr(quality_control, "Sample", FakeSample)
